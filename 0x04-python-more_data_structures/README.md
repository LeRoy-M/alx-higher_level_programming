0. Squared simple [0-square_matrix_simple.py] >> Funtion that computes the square value of all integers of a matrix
1. Search and replace [1-search_replace.py] >> Function that replaces all occurences of an element by another in a new list
...
6. Print sorted dictionary [6-print_sorted_dictionary.py] >> Function to print a dictionary by ordered keys
7. Update dictionary [7-update_dictionary.py] >> Function to replace or add key/value in a dictionary
8. Simple delete by key [8-simple_delete.py] >> Function that deletes a key in dictionary
9. Multiply by 2 [9-multiply_by_2.py] >> Functino that returns a new dictionary with all values multiplied by 2
...
12. Romans to Integer [12-roman_to_int.py] >> Function that converts a Roman numeral to an integer
