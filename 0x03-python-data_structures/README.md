...
6. List of lists = Matrix [6-print_matrix_integer.py] >> Function that prints a matrix of integers
...
12. Switch [12-switch.py] >> Switches value of 'a' and 'b' once provided source code is completed
13. Linked list palindrome [13-is_palindrome.c, lists.h] >> Function in C that checks if a singly linked list is a palindrome
14. CPython #0: Python lists [100-print_python_list_info.c] >> Function that prints some basic info about Python lists
