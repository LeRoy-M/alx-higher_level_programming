...
4. Eval is magic [4-rectangle.py] >> Class 'Rectangle' that defnes a rectangle by: (based on '3-rectangle.py')
...
10. N queens [101-nqueens.py] >> Program that solves the N queens problem
