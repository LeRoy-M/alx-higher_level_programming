...
4. Text indentation [5-text_indentation.py, tests/5-text_indentation.txt] >> Function that prints a text with 2 new lines after each of these characters: '.', '?' and more
...
7. Lazy matrix multiplication [101-lazy_matrix_mul.py, tests/101-lazy_matrix_mul.txt] >> Function that multiplies 2 matrices by using the module 'NumPy'
